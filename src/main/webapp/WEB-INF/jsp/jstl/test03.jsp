...
<body>
	<div class="container">
		...
		<table class="table text-center">
			...
			<tbody>
				<c:forEach var="candidates" items="${candidateList }" varStatus="status">
				<tr>
					<td>${status.count }</td>
		...
		<table class="table text-center">
			...
			<tbody>
				...
				<fmt:parseDate value="${bills.date }" pattern="yyyy-MM-dd" var="billDate" />
				<tr>
					<td>${bills.store }</td>
					<td><fmt:formatNumber value="${bills.pay }" type="currency" /></td>
					<td><fmt:formatDate value="${billDate }" pattern="yyyy년 MM월 dd일" /></td>
